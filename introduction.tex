...
\figurename \ref{nixie_clock_front_with_description} のButton3を利用することで，\figurename \ref{mode-flow} のに記載されてるようなモード遷移が出来る．
具体的には，Button3を押したときは図の矢印方向にモード遷移する．

またButton1，Button2は，あらかじめあるモードを設定しておくことで，押すと一発で元設定していたモードに遷移することが出来るようになっている．
